 ...
 */
public class MintNFTTransaction extends VBox {
...
Tranaction time: 1.345 seconds
    ...
    Text header = new Text("  Mint NFT transaction");
    AccountInfo accInfo;
    TextField tfTokenId = new TextField(); // .setTokenName("diploma")
    TextField tfMetadata = new TextField();
    TextField tfsupplyKey = new TextField();
    ...
    public VBox mint() {
        ...
        Label lbMetadata = new Label("Meta data:");
        lbMetadata.setId("metadata");
        lbMetadata.setFont(fnt14);
        grid_1.add(lbMetadata, 0, 2);
        grid_1.add(tfMetadata, 1, 2);

       Label lbSupplyKey = new Label("Supply Key:");
        lbSupplyKey.setId("supplyKey");
        lbSupplyKey.setFont(fnt14);
        grid_1.add(lbSupplyKey, 0, 3);
        grid_1.add(tfsupplyKey, 1, 3);
