 ...
 * @author shakir.gusaroff
 */
public class CreateAFileTransaction extends VBox {
...
Tranaction time: 1.305 seconds
The new file Id: 0.0.56171
    ...
    Text header = new Text("Create a file transaction");
    AccountInfo accInfo;
    Button buttonCreateAFile = new Button("Create a file");
    final HBox hb_taskProgress = new HBox();
    TextArea fileContentsTa = new TextArea();
    TextArea notification = new TextArea();
    final ProgressIndicator progressIndicator = new ProgressIndicator(0);

    public CreateAFileTransaction() {
        super(10);
    ...
    public Task<String> createTask() throws Exception {
        return new Task<String>() {
            ...
            protected String call() throws Exception {
                String a = new CreateAFile().createAFile(accInfo.networkChoiceBox.getValue().toString(), accInfo.tfHederaAccount.getText(), accInfo.tfPrivateKey.getText(), fileContentsTa.getText());
