 ...
 */
public class CreateATopicTransaction extends VBox {
    ...
    Text header = new Text("Create a topic transaction");
    AccountInfo accInfo;
    Button buttonCreateATopic = new Button("Create a topic");
    final HBox hb_taskProgress = new HBox();
   // TextArea fileContentsTa = new TextArea();
    TextArea notification = new TextArea();
    final ProgressIndicator progressIndicator = new ProgressIndicator(0);

    public CreateATopicTransaction() {
        super(10);
     ...
     */
        getChildren().add(buttonCreateATopic);
       // getChildren().add(new H());
        ...
        buttonCreateATopic.setOnAction((ActionEvent event) -> {
    ...
    public Task<String> createTask() throws Exception {
        return new Task<String>() {
            ...
            protected String call() throws Exception {
                String a = new CreateATopic().createATopic(accInfo.networkChoiceBox.getValue().toString(), accInfo.tfHederaAccount.getText(), accInfo.tfPrivateKey.getText());
