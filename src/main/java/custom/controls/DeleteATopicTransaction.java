 ...
 */
public class DeleteATopicTransaction extends VBox {
...
The new account balance is: 10 ℏ
    ...
    Text header = new Text("Delete a topic transaction");
    AccountInfo accInfo;
    Button buttonDeleteATopic = new Button("Delete a topic");
   ...
   // TextArea fileContentsTa = new TextArea();
    ...
    public DeleteATopicTransaction() {
        super(10);
        ...
        getChildren().add(buttonDeleteATopic);
       // getChildren().add(new H());
        ...
        buttonDeleteATopic.setOnAction((ActionEvent event) -> {
    ...
    public Task<String> createTask() throws Exception {
        return new Task<String>() {
            ...
            protected String call() throws Exception {
                String a = new DeleteATopic().deleteATopic(accInfo.networkChoiceBox.getValue().toString(), accInfo.tfHederaAccount.getText(), accInfo.tfPrivateKey.getText(), topicIdTf.getText());
