 ...
 */
public class DeleteAFileTransaction extends VBox {
...
The new account balance is: 10 ℏ
    ...
    Text header = new Text("Delete a file transaction");
    AccountInfo accInfo;
    Button buttonDeleteAFile = new Button("Delete a file");
    ...
    public DeleteAFileTransaction() {
        ...
        getChildren().add(buttonDeleteAFile);
       // getChildren().add(new H());
        ...
        buttonDeleteAFile.setOnAction((ActionEvent event) -> {
    ...
    public Task<String> createTask() throws Exception {
        return new Task<String>() {
            ...
            protected String call() throws Exception {
                String a = new DeleteAFile().deleteAFile(accInfo.networkChoiceBox.getValue().toString(), accInfo.tfHederaAccount.getText(), accInfo.tfPrivateKey.getText(), fileIdTf.getText());
