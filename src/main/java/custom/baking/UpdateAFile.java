...
content "abc_gus"
    */ 
    ...
    public String updateAFile(String network, String hederaAccount, String hederaPrivateKey, String fileContents, String fileId) {
        ...
        try {
            ...
            TransactionResponse transactionResponse = new FileUpdateTransaction().setFileId(FileId.fromString(fileId))
           ...
           // FileId newFileId = receipt.fileId;
            ...
            sb.append("A file updated successfully" + "\n");
