...
content "abc_gus"
    ...
    public String deleteAFile(String network, String hederaAccount, String hederaPrivateKey, String fileId) {
        ...
        try {
            ...
            TransactionResponse transactionResponse = new FileDeleteTransaction().setFileId(FileId.fromString(fileId))
            ...
            sb.append("A file deleted successfully" + "\n");
